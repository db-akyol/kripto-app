          ...
          <div class="p-6 overflow-y-auto flex-1 custom-scrollbar">
            ...
            <div class="space-y-5 mb-6">
              ...
              <div v-if="selectedCoin">
                <label class="block text-sm font-medium text-gray-400 mb-2 ml-1">Ortalama Alış Fiyatı ($)</label>
                <div class="relative">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-400 mb-2 ml-1">Birim Fiyat (Güncel)</label>
                <div class="relative">
                  <span class="absolute left-4 top-3.5 text-gray-500">$</span>
                  <input
                    type="number"
                    v-model="price"
                    disabled
                    class="w-full bg-gray-800/50 border border-gray-700 text-gray-400 pl-8 pr-4 py-3.5 rounded-xl focus:outline-none cursor-not-allowed transition-all font-mono opacity-60"
                  />
                </div>
              </div>
            </div>
...
function selectCoin(coin) {
  ...
  buyPrice.value = coin.price; // Set buyPrice to current price on selection
